...
import com.adu.runing.pedomemter.StepService;
import com.adu.runing.util.AppUtils;
import com.adu.runing.util.Constant;
import com.adu.runing.util.DensityUtil;
import com.adu.runing.view.CircleButton;
import com.adu.runing.view.CircleWaveButton;
import com.adu.runing.view.HintDialog;
import com.adu.runing.view.WaveView;
...
public class WalkingActivity extends AppCompatActivity implements  Handler.Callback{
    ...
    @BindView(R.id.stop) CircleButton stop;             //停止
    @BindView(R.id.start) CircleWaveButton start;       //开始
